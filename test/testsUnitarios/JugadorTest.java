...
public class JugadorTest {
	...
	@Test
	public void testEsDueñoDevuelveTrueCuandoJugadorTomaDelMazoUnaCarta() {
		...
		assertTrue(jugador.esDueñoDe(carta));
	}
	
	@Test
	public void testEsDueñoDevuelveTrueCuandoJugadorPoneLaCartaMonstruoEnLaZonaDeMonstruos() {
		...
		assertTrue(jugador.esDueñoDe(monstruo));
	}
	
	@Test
	public void testEsDueñoDevuelveTrueCuandoJugadorPoneLaCartaMagicaEnLaZonaEspeciales () {
		...
		assertTrue(jugador.esDueñoDe(magica));
	}
	
	@Test
	public void testEsDueñoDevuelveTrueCuandoJugadorNoTomaLaCartaDelMazo() {
		...
		assertFalse(jugador.esDueñoDe(carta));
	}
}
